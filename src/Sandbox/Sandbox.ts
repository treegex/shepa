...
export default class Sandbox extends Driver {

    private tokenUrl = 'https://sandbox.shepa.com/api/v1/token';
    private verifyUrl = 'https://sandbox.shepa.com/api/v1/verify';
